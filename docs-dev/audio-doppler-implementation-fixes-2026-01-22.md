...
## Scope
Implements the recommended actions from `docs-dev/proposed/doppler-implementation-analysis.md` to stabilize doppler playback for looped projectile sounds.
