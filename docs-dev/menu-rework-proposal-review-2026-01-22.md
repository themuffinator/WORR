...
## Summary
This document records the updates applied to `docs-dev/proposals/menu_rework.md` after the repo-aware review, focusing on JSON alignment, cvar correctness, and scope decisions.
...
## Files Updated
- `docs-dev/proposals/menu_rework.md`
