...
The WORR GL renderer follows a traditional **CPU-driven immediate mode** approach inherited from Quake II engine architecture. After deep analysis, I've identified **significant CPU overheads** that could be offloaded to the GPU, potentially yielding **2-5x performance improvements** for complex scenes, inspired by Ironwail's modern GPU-driven approach.
...
**Files:** [surf.c](../../src/rend_gl/surf.c)
...
**Files:** [mesh.c](../../src/rend_gl/mesh.c)
...
**Files:** [world.c](../../src/rend_gl/world.c)
...
**Files:** [tess.c](../../src/rend_gl/tess.c)
...
| Feature | WORR Current | Ironwail Modern |
|---------|----------------|-----------------|
