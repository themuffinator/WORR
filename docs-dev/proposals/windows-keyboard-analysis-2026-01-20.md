...
The WORR project has a custom Windows keyboard implementation that bypasses SDL for more direct control. The implementation resides primarily in:

- [client.c](../../src/windows/client.c) - Windows-specific input handling
- [keys.cpp](../../src/client/keys.cpp) - Client-side key event processing

Recent updates (documented in `docs-dev/windows-keyboard-*.md`) added layout-aware translation, UTF-8 handling, and Unicode support. This analysis identifies remaining issues and potential improvements.
...
**Location**: [win_translate_char_key()](../../src/windows/client.c#L719-L747)
...
**Location**: [win_translate_vk()](../../src/windows/client.c#L749-L885)
...
**Location**: [win_translate_char_key()](../../src/windows/client.c#L719-L747) and [VK_SHIFT handling](../../src/windows/client.c#L796-L800)
...
**Location**: [Win_Init()](../../src/windows/client.c#L1279)
...
**Location**: [win_utf8_state_t](../../src/windows/client.c#L593-L606)
...
**Location**: [Key_Event()](../../src/client/keys.cpp#L707-L716)
...
**Location**: [win_translate_char_key()](../../src/windows/client.c#L733-L745)
...
| File | Changes |
|------|---------|
| [src/windows/client.c](../../src/windows/client.c) | Dead key handling, AltGr detection, layout caching, UTF-8 reset, WM_INPUTLANGCHANGE |
| [src/windows/client.h](../../src/windows/client.h) | Add `keyboard_layout` field to `win_state_t` |
| [src/client/keys.cpp](../../src/client/keys.cpp) | Scancode-based console toggle suppression |
