...
This document outlines a detailed plan for replacing WORR-2's Quake 2-based event and packet system with ideas from Quake 3 Arena's superior, more efficient, and robust architecture.

---

## System Comparison

### Quake 2 (Current WORR-2)
...
> [!NOTE]
> No existing automated networking tests found in WORR-2. New tests should be added.
