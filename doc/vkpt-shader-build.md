...
This document covers the shader compilation flow added for the Q2RTX vkpt port in WORR-2 and the startup guard that prevents Vulkan initialization from crashing when SPIR-V modules are missing.
