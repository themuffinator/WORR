...
cl_crosshairHealth::
    ...
    `cl_crosshairColor`. Default value is 0 (use static color).

cl_crosshairHitColor::
    Crosshair hit color index (1-26) used by hit styles 2, 5, and 8. Default
    value is 1.

cl_crosshairHitStyle::
    Controls crosshair hit feedback. Default value is 2.
      ...
      - 6 - pulse (small, matches `cl_crosshairPulse`)
