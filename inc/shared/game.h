...
typedef struct
{
    ...
    void (*AddDamageDisplay)(int32_t isplit, int damage, const vec3_t color, const vec3_t dir);
    void (*AddPOI)(int32_t isplit, int id, int time, const vec3_t pos, int image, int color, int flags);
