...
QGLAPI void (APIENTRYP qglCopyTexSubImage2D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height);
...
QGLAPI void (APIENTRYP qglReadBuffer)(GLenum mode);
...
QGLAPI void (APIENTRYP qglStencilMask)(GLuint mask);
...
QGLAPI void (APIENTRYP qglCopyTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
