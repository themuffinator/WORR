...
static void add_string(menuSpinControl_t *s, const char *tok)
{
    if (s->numItems < MAX_MENU_ITEMS) {
        s->itemnames = static_cast<char **>(
            Z_Realloc(s->itemnames, Q_ALIGN(s->numItems + 2, MIN_MENU_ITEMS) * sizeof(char *)));
...
static void long_args_hack(menuSpinControl_t *s, int argc)
{
    ...
    s->itemnames = static_cast<char **>(UI_Malloc(MIN_MENU_ITEMS * sizeof(char *)));
...
static void Parse_Spin(menuFrameWork_t *menu, menuType_t type)
{
    ...
    if (strchr(Cmd_ArgsFrom(cmd_optind), '$')) {
        ...
        s->itemnames = static_cast<char **>(UI_Mallocz(sizeof(char *) * (numItems + 1)));
...
static void Parse_EpisodeSelector(menuFrameWork_t *menu)
{
    ...
    s = static_cast<menuEpisodeSelector_t *>(UI_Mallocz(sizeof(*s)));
...
static void Parse_UnitSelector(menuFrameWork_t *menu)
{
    ...
    s = static_cast<menuUnitSelector_t *>(UI_Mallocz(sizeof(*s)));
...
static void Parse_Pairs(menuFrameWork_t *menu)
{
    ...
    numItems /= 2;
    s->itemnames = static_cast<char **>(UI_Mallocz(sizeof(char *) * (numItems + 1)));
    s->itemvalues = static_cast<char **>(UI_Mallocz(sizeof(char *) * (numItems + 1)));
    for (i = 0; i < numItems; i++) {
...
static void Parse_Range(menuFrameWork_t *menu)
{
    ...
    s = static_cast<menuSlider_t *>(UI_Mallocz(sizeof(*s)));
...
static void Parse_Action(menuFrameWork_t *menu)
{
    ...
    a = static_cast<menuAction_t *>(UI_Mallocz(sizeof(*a)));
...
static void Parse_Bitmap(menuFrameWork_t *menu)
{
    ...
    b = static_cast<menuBitmap_t *>(UI_Mallocz(sizeof(*b)));
...
static void Parse_Bind(menuFrameWork_t *menu)
{
    ...
    k = static_cast<menuKeybind_t *>(UI_Mallocz(sizeof(*k)));
...
static void Parse_Toggle(menuFrameWork_t *menu)
{
    ...
    s->generic.status = UI_CopyString(status);
    s->cvar = Cvar_WeakGet(Cmd_Argv(cmd_optind + 1));
    s->itemnames = const_cast<char **>(yes_no_names);
    s->numItems = 2;
    s->negate = negate;
    s->mask = 1U << bit;
...
static void Parse_Field(menuFrameWork_t *menu)
{
    ...
    f = static_cast<menuField_t *>(UI_Mallocz(sizeof(*f)));
...
static void Parse_Blank(menuFrameWork_t *menu)
{
    ...
    s = static_cast<menuSeparator_t *>(UI_Mallocz(sizeof(*s)));
        ...
        if (argc) {
            ...
            if (menu) {
                ...
                if (!strcmp(cmd, "begin")) {
                    ...
                    menu = static_cast<menuFrameWork_t *>(UI_Mallocz(sizeof(*menu)));
