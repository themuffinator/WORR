...
cvar_t  *cl_rollhack;
cvar_t  *cl_noglow;
cvar_t  *cl_item_bob_style;
cvar_t  *cl_item_rotate_style;
cvar_t  *cl_nolerp;
...
cvar_t  *info_fov;
cvar_t  *info_msg;
cvar_t  *info_autoswitch;
cvar_t  *info_autoshield;
cvar_t  *info_hand;
cvar_t  *info_bobskip;
cvar_t  *info_gender;
cvar_t  *info_uf;
...
static void CL_InitLocal(void)
{
    ...
    cl_item_bob_style = Cvar_Get("cl_item_bob_style", "2", 0);
    cl_item_rotate_style = Cvar_Get("cl_item_rotate_style", "2", 0);
    ...
    info_autoswitch = Cvar_Get("autoswitch", "0", CVAR_USERINFO | CVAR_ARCHIVE);
    info_autoshield = Cvar_Get("autoshield", "0", CVAR_USERINFO | CVAR_ARCHIVE);
