...
/* Named arrays: MSVC C4576 rejects (Type[]){...} compound literals in C++ */
static const alfunction_t section_core[] = {
    QALC_FN(CloseDevice),
...
static const alfunction_t section_efx[] = {
...
static const alsection_t sections[] = {
    { .functions = section_core },
    { .extension = "ALC_EXT_EFX", .functions = section_efx },
};
