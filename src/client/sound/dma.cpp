...
static sfxcache_t *DMA_UploadSfx(sfx_t *sfx)
{
    ...
    sfxcache_t *sc = sfx->cache = static_cast<sfxcache_t *>(S_Malloc(sizeof(*sc) + size - 1));
...
#ifdef _WIN32
extern "C" const snddma_driver_t    snddma_dsound;
extern "C" const snddma_driver_t    snddma_wave;
#endif
