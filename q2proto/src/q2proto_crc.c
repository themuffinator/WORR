...
static uint16_t q2proto_crc_block(const uint8_t *start, size_t count)
{
...
static const uint8_t chktbl[1024] = {
    ...
    0x19, 0x27, 0xfb, 0xb8, 0xf5, 0x32, 0x73, 0xe5, 0xcb, 0x32};
...
q2proto_error_t q2proto_block_sequence_crc_byte(const uint8_t *base, size_t length, int sequence, uint8_t *result)
{
    ...
    const uint8_t *p = chktbl + (sequence % (sizeof(chktbl) - 4));
    ...
    uint16_t crc = q2proto_crc_block(chkb, length);
